...
def buyItemfl():
    ...
    mongo.db.Users.find_one_and_update({'authId': itemObject['owner']}, {'$pull': {'currentProducts': productId}, '$addToSet': {'donations': int(itemObject['price'])}})
    ...
    mongo.db.Transactions.insert_one({'t_id': transactionId, 'price': itemObject['price'], 'owner': itemObject['owner'], 'buyer': authId})
