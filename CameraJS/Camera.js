                    ...
                    <Camera style={{ flex: 1, justifyContent: 'space-between' }} type={this.state.type} >
                        ...
                        >
                            <View style={{ flexDirection: 'row', flex: 4 }}>
                                ...
                                <Item style={{ backgroundColor: 'transparent' }}>
                                    <Icon name="android-search" style={{ color: 'white', fontSize: 24, fontWeight: 'bold' }}></Icon>
                            ...
                            <View style={{ flexDirection: 'row', flex: 2, justifyContent: 'space-around' }}>
                                <Icon name="android-flash" style={{ color: 'white', fontWeight: 'bold' }} />
                                <Icon
                                    onPress={() => {
                                        this.setState({
                                    ...
                                    name="android-reverse-camera" style={{ color: 'white', fontWeight: 'bold' }} />
                            </View>
                        </Header>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, marginBottom: 15, alignItems: 'flex-end' }}>
                            ...
                            <View style={{ alignItems: 'center' }}>
                                ...
                                ></MaterialCommunityIcons>
                                <Icon name="android-images" style={{ color: 'white', fontSize: 36 }} />
                            </View>
